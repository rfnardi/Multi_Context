...
REGRA ABSOLUTA DE FORMATO: Para invocar uma ferramenta, você DEVE usar ESTRITAMENTE o formato de tags XML exemplificado abaixo.
É ESTRITAMENTE PROIBIDO usar formato JSON. NÃO ENVOLVA os argumentos com tags extras.

=== SMART PUSH (AUTO-LSP) ===
Sempre que usar ferramentas de edição, a geração de texto será pausada e o sistema injetará automaticamente os erros sintáticos (LSP).
NÃO CHAME get_diagnostics logo após editar, leia a resposta do sistema.

...
M.dict = {
    en = {
        ...
        danger_cmd = "DANGEROUS command detected.",
        ...
        cc_load = "Load",
        cc_squad = "Squad",
        swarm_api_empty = "API returned empty. Returning task to queue (Attempt %d/2)...",
        ...
        swarm_api_fail = "API Failure (%s). Returning to queue (Attempt %d/2)...",
    ...
    ["pt-BR"] = {
        ...
        danger_cmd = "Comando PERIGOSO detectado.",
        ...
        cc_load = "Load",
        cc_squad = "Squad",
        swarm_api_empty = "API retornou vazio. Devolvendo tarefa para a fila (Tentativa %d/2)...",
        ...
        swarm_api_fail = "Falha na API (%s). Devolvendo para a fila (Tentativa %d/2)...",

...
echo "🩹 Restaurando todos os testes do CLI e unificando a Suíte..."
...
echo "✅ Arquivo cli_spec.lua recriado com sucesso! Contendo os 9 testes integrais."
echo "Rode 'make test' novamente, veremos o número correto saltar!"
